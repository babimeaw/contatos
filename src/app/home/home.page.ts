...
let c1 : Contato = new Contato("Tamilyn Camille Costa",91094415, "tamilyn.cc@hotmail.com.br")
let c2 : Contato = new Contato("Yasmim Haffermann Bilovus",91094400, "yasmimhb@gmail.com")
let c3 : Contato = new Contato("Ermindo Treviso Neto",91091115,"ermindone@gmail.com" )
let c4 : Contato = new Contato("Gabriel Dibs",91091100, "dibzinho@gmail.com")
